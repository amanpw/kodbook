package com.kodbook.com.kodbook.entities;
	 ...
	 @Id
		...
		public String toString() {
			return "Post [id=" + id + ", caption=" + caption + ", likes=" + likes + ", comments=" + comments + ", photo="
					+ Arrays.toString(photo) + ", getPhotoBase64()=" + getPhotoBase64() + ", getId()=" + getId()
					+ ", getCaption()=" + getCaption() + ", getLikes()=" + getLikes() + ", getComments()=" + getComments()
